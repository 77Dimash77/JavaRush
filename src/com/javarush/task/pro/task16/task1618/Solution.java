...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ...
        ZonedDateTime tolik = ZonedDateTime.of(fromDateTime,fromZone);
        ZonedDateTime nolik = tolik.withZoneSameInstant(toZone);
        LocalDateTime result = nolik.toLocalDateTime();
        return result;
    }
}
